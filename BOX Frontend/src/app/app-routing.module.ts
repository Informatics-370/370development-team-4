...
const routes: Routes = [
  ...
  { path: "dashboard", component: DashboardComponent, canActivate: [RoleAuthGuard], data: { allowedRoles: ['Administrator', 'Employee', 'Delivery Driver']} },
  ...
  { path: 'employees', component: EmployeesComponent, canActivate: [RoleAuthGuard], data: { allowedRoles: ['Administrator', 'Employee', 'Delivery Driver']} },
  ...
  { path: 'assign-employee', component: AssignEmployeeComponent, canActivate: [RoleAuthGuard], data: { allowedRoles: ['Administrator', 'Employee', 'Delivery Driver']} },
