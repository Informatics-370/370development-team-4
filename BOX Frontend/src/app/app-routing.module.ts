...
const routes: Routes = [
  ...
  { path: "dashboard", component: DashboardComponent, canActivate: [RoleAuthGuard], data: { allowedRoles: ['Administrators', 'Employee', 'Delivery Driver']} },
  ...
  { path: "product-item", component: ProductItemTestComponent, canActivate: [RoleAuthGuard], data: { allowedRoles: ['Administrators', 'Employee', 'Delivery Driver']} },
  { path: "help", component: ViewHelpInventoryComponent, canActivate: [RoleAuthGuard], data: { allowedRoles: ['Administrators', 'Employee', 'Delivery Driver']} },
  { path: "product-category", component: ProductCategoryComponent, canActivate: [RoleAuthGuard], data: { allowedRoles: ['Administrators', 'Employee', 'Delivery Driver']} },
  { path: "return-reason", component: RefundReasonComponent, canActivate: [RoleAuthGuard], data: { allowedRoles: ['Administrators', 'Employee', 'Delivery Driver']} },
  { path: "write-off-reason", component: WriteOffReasonComponent, canActivate: [RoleAuthGuard], data: { allowedRoles: ['Administrators', 'Employee', 'Admin', 'Delivery Driver']} },
  { path: 'size-units', component: SizeUnitsComponent, canActivate: [RoleAuthGuard], data: { allowedRoles: ['Administrators', 'Employee', 'Delivery Driver']} },
  { path: 'vat', component: VatComponent, canActivate: [RoleAuthGuard], data: { allowedRoles: ['Administrators', 'Employee', 'Delivery Driver']} },
  { path: "supplier", component: SupplierComponent, canActivate: [RoleAuthGuard], data: { allowedRoles: ['Administrators', 'Employee', 'Delivery Driver']} },
  { path: "fixed-product", component: FixedProductComponent, canActivate: [RoleAuthGuard], data: { allowedRoles: ['Administrators', 'Employee', 'Delivery Driver']} },
  { path: 'raw-material', component: RawMaterialComponent, canActivate: [RoleAuthGuard], data: { allowedRoles: ['Administrators', 'Employee', 'Delivery Driver']} },
  ...
  { path: 'cost-price-formula-variables', component: CostPriceFormulaComponent, canActivate: [RoleAuthGuard], data: { allowedRoles: ['Administrators', 'Employee', 'Delivery Driver']} },
  ...
  { path: 'supplier-order', component: SupplierOrderComponent, canActivate: [RoleAuthGuard], data: { allowedRoles: ['Administrators', 'Employee', 'Delivery Driver']} },
  { path: 'supplier-return', component: SupplierReturnComponent, canActivate: [RoleAuthGuard], data: { allowedRoles: ['Administrators', 'Employee', 'Delivery Driver']} },
  { path: 'roles', component: RolesComponent, canActivate: [RoleAuthGuard], data: { allowedRoles: ['Administrators', 'Employee', 'Delivery Driver']} },
  { path: 'discount', component: DiscountComponent, canActivate: [RoleAuthGuard], data: { allowedRoles: ['Administrators', 'Employee', 'Delivery Driver']} },
  { path: 'stock-take', component: StockTakeComponent, canActivate: [RoleAuthGuard], data: { allowedRoles: ['Administrators', 'Employee', 'Admin', 'Delivery Driver']} },
  { path: 'stock-take-trail', component: StockTakeTrailComponent, canActivate: [RoleAuthGuard], data: { allowedRoles: ['Administrators', 'Employee', 'Delivery Driver']} },
  { path: 'users', component: UsersViewComponent, canActivate: [RoleAuthGuard], data: { allowedRoles: ['Administrators', 'Employee', 'Delivery Driver']} },
  ...
  { path: 'order-history', component: OrderHistoryComponent, canActivate: [RoleAuthGuard], data: { allowedRoles: ['Customer', 'Admin', 'Employee']} },
  ...
  { path: 'manage-orders', component: CustomerOrdersComponent, canActivate: [RoleAuthGuard], data: { allowedRoles: ['Administrators', 'Employee', 'Delivery Driver']} },
  { path: 'custom-product', component: CustomProdComponent, canActivate: [RoleAuthGuard], data: { allowedRoles: ['Administrators', 'Employee', 'Delivery Driver']} },
  ...
  { path: 'employees', component: EmployeesComponent, canActivate: [RoleAuthGuard], data: { allowedRoles: ['Administrators', 'Employee', 'Delivery Driver']} },
  ...
  { path: 'quote-requests', component: QouteRequestsComponent, canActivate: [RoleAuthGuard], data: { allowedRoles: ['Administrators', 'Employee', 'Admin', 'Delivery Driver']} },
  { path: 'sales-by-category', component: SalesByCategoryReportComponent, canActivate: [RoleAuthGuard], data: { allowedRoles: ['Administrators', 'Employee', 'Delivery Driver']} },
  { path: 'product-list', component: ProductListReportComponent, canActivate: [RoleAuthGuard], data: { allowedRoles: ['Administrators', 'Employee', 'Admin', 'Delivery Driver']} },
  { path: 'inactive-customers', component: InactiveCustomerListComponent, canActivate: [RoleAuthGuard], data: { allowedRoles: ['Administrators', 'Employee', 'Delivery Driver']} },
  { path: 'assign-employee', component: AssignEmployeeComponent, canActivate: [RoleAuthGuard], data: { allowedRoles: ['Administrators', 'Employee', 'Delivery Driver']} },
  { path: 'supplier-list', component: SupplierListComponent, canActivate: [RoleAuthGuard], data: { allowedRoles: ['Administrators', 'Employee', 'Delivery Driver']} },
  { path: 'review-report', component: ReviewReportComponent, canActivate: [RoleAuthGuard], data: { allowedRoles: ['Administrators', 'Employee', 'Delivery Driver']} },
  { path: 'write-off-report', component: WriteOffByProductCategoryComponent, canActivate: [RoleAuthGuard], data: { allowedRoles: ['Administrators', 'Employee', 'Delivery Driver']} },
  { path: 'inventory-chart', component: InventoryChartComponent, canActivate: [RoleAuthGuard], data: { allowedRoles: ['Administrators', 'Employee', 'Delivery Driver']} },
  { path: 'messages', component: MessagesComponent, canActivate: [RoleAuthGuard], data: { allowedRoles: ['Administrators', 'Employee', 'Delivery Driver']} },
  { path: 'order-schedule', component: OrderDeliveryScheduleComponent, canActivate: [RoleAuthGuard], data: { allowedRoles: ['Administrators', 'Employee', 'Delivery Driver']} },
  { path: 'order-calendar', component: OrderDelCalendarComponent, canActivate: [RoleAuthGuard], data: { allowedRoles: ['Administrators', 'Employee', 'Delivery Driver']} },
  { path: 'manage-quotes', component: QuotesComponent, canActivate: [RoleAuthGuard], data: { allowedRoles: ['Administrators', 'Employee', 'Delivery Driver']} }
];
