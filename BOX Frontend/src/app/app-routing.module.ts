...
const routes: Routes = [
  ...
  { path: "write-off-reason", component: WriteOffReasonComponent, canActivate: [RoleAuthGuard], data: { allowedRoles: ['Administrators', 'Employee']} },
  ...
  { path: 'stock-take', component: StockTakeComponent, canActivate: [RoleAuthGuard], data: { allowedRoles: ['Administrators', 'Employee']} },
  ...
  { path: 'product-list', component: ProductListReportComponent, canActivate: [RoleAuthGuard], data: { allowedRoles: ['Administrators', 'Employee']} },
